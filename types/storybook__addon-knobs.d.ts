...
declare module '@storybook/addon-knobs' {
	...
	export function select<
		T extends Exclude<
			React.RenderableProps<HTMLOptionElement>['value'],
			undefined
		>
	...
	export function withKnobs(storyFn: RenderFunction, context: StoryContext): Renderable;
	export function withKnobsOptions(options: { debounce: boolean, timestamps: boolean }): (storyFn: RenderFunction, context: StoryContext) => Renderable;
}
